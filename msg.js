...
var msg = {
	...
	popups:function(attribute){
		...
		if(attribute.url != null){
			...
			attribute.text = '<iframe src="'+attribute.url+'" frameborder="0" style="width:100%;height:100%; border-radius: 0.3rem; display:none;" onload="document.getElementById(\'msg_popups_loading\').style.display=\'none\'; this.style.display=\'\';"></iframe><div id="msg_popups_loading" style="width:100%;height:100%; text-align:center; margin-top: 30%; font-size: 1.4rem;">加载中...</div>';
		}
