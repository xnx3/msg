...
var msg = {
	 ...
	 */
	delayClose(time){
		setTimeout(function(){ console.log('-ss'); msg.close(); },time);
	},
	/**
	 * 显示提示窗口，私有方法
	 * text 提示文字
	...
	show(text, img){
		...
		if(document.getElementsByTagName("body") != null && document.getElementsByTagName("body").length > 0){
			...
			div.innerHTML = ''
				+'<div id="loading" style="position: fixed;width: 100%;top: 30%;text-align: center;font-size: 1rem;color: #dedede;margin: 0px auto;left: 50%;margin-left: -3.5rem;">'
